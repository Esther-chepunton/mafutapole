    ...
    <ul className="grid mt-10 sm:grid-cols-2 lg:grid-cols-4 text-white">
      <li className='block overflow-hidden group bg-[#833556] opacity-70 sm:h-[450px] h-[350px]'>
        <div className='ml-10 pr-5' >
            ...
            <h1 className='font-bold text-4xl  pt-14'>We Educate</h1>
            <p className=' text-lg mt-7'>We run small-scale schools for the underprivileged children and youth of daily wage workers for a better future.</p>
